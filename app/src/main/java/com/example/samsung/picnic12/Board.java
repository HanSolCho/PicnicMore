...
public class Board extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Board.GetData task = new Board.GetData();
        //num 조건 동일한거 가져오도록 설정해주기
        //우선 num.을 넘겨줘야겠네
        task.execute("http://whgksthf702.vps.phps.kr/BoardContent0.php", num);
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Picasso.with(Board.this)
                        .load("http://whgksthf702.vps.phps.kr/uploads/"+proimg)
                        .into(proimgview);

                if(image1.contains(".jpg")) {
                    Picasso.with(Board.this)
                            .load("http://whgksthf702.vps.phps.kr/uploads/"+image1)
                            .into(imageView1);
                ...
                if(image2.contains(".jpg")) {
                    Picasso.with(Board.this)
                            .load("http://whgksthf702.vps.phps.kr/uploads/"+image2)
                            .into(imageView2);
                }
                else{
                ...
                if(image3.contains(".jpg")) {
                    Picasso.with(Board.this)
                            .load("http://whgksthf702.vps.phps.kr/uploads/"+image3)
                            .into(imageView3);
                }
                else{
                ...
                if(image4.contains(".jpg")) {
                    Picasso.with(Board.this)
                            .load("http://whgksthf702.vps.phps.kr/uploads/"+image4)
                            .into(imageView4);
                }
                else{
                ...
                if(image5.contains(".jpg")) {
                    Picasso.with(Board.this)
                            .load("http://whgksthf702.vps.phps.kr/uploads/"+image5)
                            .into(imageView5);
                }
                else{
...
//                        }
                ...
                Board.GetData2 task2 = new Board.GetData2();
                task2.execute("http://whgksthf702.vps.phps.kr/RepleContent0.php", boardnum);
        }
