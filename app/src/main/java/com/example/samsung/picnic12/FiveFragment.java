...
public class FiveFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.fragment_five, container, false);
...
//        m_ListView.setAdapter(m_Adapter);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.addboard:
                intent = new Intent(getContext(), NewBoard.class);
        }
...
//        m_Adapter = new BoardAdapter();
        ...
        task.execute("http://whgksthf702.vps.phps.kr/BoardList0.php");
    }
