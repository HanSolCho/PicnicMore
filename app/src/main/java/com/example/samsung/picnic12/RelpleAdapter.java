...
public class RelpleAdapter extends BaseAdapter {
    ...
    //아이템 담을 리스트
    private ArrayList<RelpleAdapter.ListContents> m_List;

    public RelpleAdapter() {
        m_List = new ArrayList<RelpleAdapter.ListContents>();
    }
    ...
    public void add(ArrayList<HashMap<String, String>> _inputValue) {
        ...
        m_List.add(new RelpleAdapter.ListContents(_inputValue));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //고정시키는거?
       RelpleAdapter.CustomHolder holder = null;
        ...
        if (convertView == null) {
            ...
            holder = new RelpleAdapter.CustomHolder();
            ...
            holder = (RelpleAdapter.CustomHolder) convertView.getTag();
