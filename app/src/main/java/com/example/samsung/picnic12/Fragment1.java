...
public class Fragment1 extends NMapFragment implements View.OnClickListener {
	...
	private static final String CLIENT_ID = "jeaCS9wmiRDu_DKbrP6R";
	...
	private Button action_my_location;
	private  Button action_path_data;

	private static final NGeoPoint NMAP_LOCATION_DEFAULT = new NGeoPoint(126.978371, 37.5666091);
	private static final int NMAP_ZOOMLEVEL_DEFAULT = 11;
	private static final int NMAP_VIEW_MODE_DEFAULT = NMapView.VIEW_MODE_TRAFFIC;
	private static final boolean NMAP_TRAFFIC_MODE_DEFAULT = true;
	...
	private double gx=37.5657037;
	private double gy=126.9768616;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		action_my_location = (Button)view.findViewById(R.id.action_my_location) ;
		action_path_data = (Button)view.findViewById(R.id.action_path_data);

		action_my_location.setOnClickListener(this);
		action_path_data.setOnClickListener(this);
...
//			getActivity().setContentView(mMapContainerView);
////		}
		...
		//	mMapView.setBackgroundColor(R.drawable.blue);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.action_my_location:	//대기정보 가져오는 버튼
                startMyLocation();
            break;
			...
			case R.id.action_path_data:
				...
				if (list != null) {
					if (list.size() == 0) {
						...
						gx=  list.get(0).getLatitude();        // 위도
						gy=  list.get(0).getLongitude();    // 경도
						Log.d("gx",Double.toString(gx));
						Log.d("gy",Double.toString(gy));
		...
		if (mMyLocationOverlay != null) {
			...
			if (mMapLocationManager.isMyLocationEnabled()) {
				...
				if (!isMyLocationEnabled) {
					//	Toast.makeText(g, "Please enable a My Location source in system settings",
...
//		pathData.endPathData();
		...
		if (pathDataOverlay != null) {
			...
			pathData2.addPathPoint(gy, gx, NMapPathLineStyle.TYPE_SOLID);
...
//				return true;
	...
	private void invalidateMenu() {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			nMapActivity.invalidateOptionsMenu();
		}
	}
