...
public class ThirdFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        if (USE_XML_LAYOUT) {
            ...
            mMapView = (NMapView)layout.findViewById(R.id.mapView);
        } else {
            // create map view
    ...
    private final NMapPOIdataOverlay.OnFloatingItemChangeListener onPOIdataFloatingItemChangeListener = new NMapPOIdataOverlay.OnFloatingItemChangeListener() {
        ...
        public void onPointChanged(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
          ...
          //  ((NMapActivity)getActivity()).findPlacemarkAtLocation(point.longitude, point.latitude);
            nMapActivity.findPlacemarkAtLocation(point.longitude, point.latitude);
...
//                return true;
    ...
    private void invalidateMenu() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
          ...
          //  ((NMapActivity)getActivity()).invalidateOptionsMenu();
            nMapActivity.invalidateOptionsMenu();
        }
    }
